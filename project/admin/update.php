...
<input type="submit" name="submit" value="search" style="margin-left:50px";>
</form>
</div>
</body>
</html>
...
if(isset($_POST['submit']))
{
	...
	else
	{
		while($data=mysqli_fetch_assoc($run))
		{
           ...
           <td><a href="../dataimage/<?php echo $data['image']; ?>" style="max-width:50%;margin-left:300px;">Download</a></td>
            </tr>
            <a href="updateform.php?sid=<?php  echo $data['id'];?>"><h2>Edit</h2></a>
            <?php
			}
